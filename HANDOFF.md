...
- 当前关键提交：
  - `fix: sync database updates into live profiles`（本轮待提交）
...
- UI 基线：`2e25551bdab242b3a4232a427a9b72033bd91d7183952a23aac66a1d535c0079`（仅聊天作用域存储与 ready 后数据刷新逻辑变化，布局与样式未改）。
